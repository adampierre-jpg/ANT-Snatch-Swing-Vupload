...
```
// Set up video event handlers FIRST
...
// Set up button handlers FIRST (before model loads)
...
// Hide the loading overlay so video can be seen
document.getElementById(“loading-overlay”).classList.add(“hidden”);
...
const vy = -(dyPx / state.lockedCalibration) / dt; // Inverted so up = positive
